namespace itm.csharp.basic
{
    public static class Menu
    {
        public static void MostrarMenu()
        {
            ...
            Console.WriteLine("2. Operaciones basicas entre dos números. ");
            ...
            Console.WriteLine("10. Comportamientos de vehiculo. ");
            Console.WriteLine("11. Ingresar 5 npumeros validos. ");
